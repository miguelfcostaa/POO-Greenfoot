...
/**
 * Write a description of class Lago here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Lago extends Actor
{
    /**
     * Act - do whatever the Lago wants to do. This method is called whenever
    ...
    public void act() {
        ...
        if (isTouching(Boy.class) || isTouching(Girl.class)){
            ...
            if (Greenfoot.isKeyDown("E") && Greenfoot.isKeyDown("I")){
                ...
                Calhau c = new Calhau();
                Score scr = new Score();
                Greenfoot.setWorld(new Fundo(hb.getHealthB(),hg.getHealthG(),fb.getFoodB(),fg.getFoodG(),wb.getWaterB(),wg.getWaterG(),m.getMadeira(),c.getPedra(),scr.getScore()));
            }
        }
        if(!isTouching(Boy.class) || isTouching(Girl.class)){
            ind.setText("");
